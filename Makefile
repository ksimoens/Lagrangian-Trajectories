...
#OPT += -DOUTLATRES=0.00109083078
#Shape of SST data grid
OPT += -DSSTGRIDNLON=2100
OPT += -DSSTGRIDNLAT=1200
#Extent of SST data grid
OPT += -DSSTGRIDLONMIN=-1.57035999448
OPT += -DSSTGRIDLONMAX=0.26136305548
OPT += -DSSTGRIDLONRES=0.00087266462
OPT += -DSSTGRIDLATMIN=0.17496925751
OPT += -DSSTGRIDLATMAX=1.22129414408
OPT += -DSSTGRIDLATRES=0.00087266462
